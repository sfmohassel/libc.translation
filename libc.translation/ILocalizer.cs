...
namespace libc.translation {
    public interface ILocalizer {
        ...
        /// <para>
        /// The translation text will be formatted using <see cref="string.Format(string,object)"/> given <see cref="values"/>
        /// </para>
        /// <para>If the translation for <see cref="culture"/> is not found, fallback culture is used</para>
        /// </summary>
        /// <param name="culture">The culture in which you need your translation to be</param>
        ...
        /// <summary>
        /// Gets all the translation text-values as a <see cref="IDictionary{TKey,TValue}"/> in the given <see cref="culture"/>
        /// </summary>
        /// <para>If the translation for <see cref="culture"/> is not found, fallback culture is used</para>
        ...
        /// <summary>
        /// Gets all the translation text-values as a <see cref="IDictionary{TKey,TValue}"/> in <see cref="CultureInfo.CurrentCulture"/>
        /// <para>If the translation for <see cref="CultureInfo.CurrentCulture"/> is not found, fallback culture is used</para>
        /// </summary>
        /// <returns></returns>
