...
namespace libc.translation {
    public interface ILocalizer {
        ...
        /// <para>
        /// The translation text will be formatted using <see cref="string.Format"/> given <see cref="values"/>
        /// </para>
        /// <para>If the translation for <see cref="culture"/> is not found, fallback culture is used</para>
        /// </summary>
        /// <param name="culture">The culture in which you need your translation to be</param>
        /// <param name="key">The key for translation text</param>
        /// <param name="values">Parameters for <see cref="string.Format"/></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets all the translation text-values as a <see cref="Dictionary{string,string}"/> in the given <see cref="culture"/>
        /// </summary>
        /// <para>If the translation for <see cref="culture"/> is not found, fallback culture is used</para>
        ...
        /// <summary>
        /// Gets all the translation text-values as a <see cref="Dictionary{string,string}"/> in <see cref="CultureInfo.CurrentCulture"/>
        /// <para>If the translation for <see cref="CultureInfo.CurrentCulture"/> is not found, fallback culture is used</para>
        /// </summary>
        /// <returns></returns>
