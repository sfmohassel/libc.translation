...
public interface ILocalizer
{
  ...
  /// <summary>
  ///   Gets the translation text for the given <see cref="key" /> and
  ///   <see cref="CultureInfo.CurrentCulture" />
  ///   <para>
  ///     If the translation for <see cref="CultureInfo.CurrentCulture" /> is not found, fallback
  ///     culture is used
  ///   </para>
  /// </summary>
  /// <param name="key">The key for translation text</param>
  ...
  /// <summary>
  ///   Gets the formatted translation text for the given <see cref="key" /> and
  ///   <see cref="CultureInfo.CurrentCulture" />
  ///   <para>
  ///     The translation text will be formatted using <see cref="string.Format(string,object)" /> given
  ///     <see cref="values" />
