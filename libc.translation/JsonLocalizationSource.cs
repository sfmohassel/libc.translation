...
public class JsonLocalizationSource : ILocalizationSource
{
  ...
  ///   The json document. You freely can dispose json document after calling
  ///   this constructor.
  /// </param>
  ...
  /// </param>
  public JsonLocalizationSource(Assembly assembly, string resourceId,
    PropertyCaseSensitivity caseSensitivity,
  ...
  ///   <see cref="JsonDocumentOptions.MaxDepth" />
  /// </param>
  public JsonLocalizationSource(Stream stream, PropertyCaseSensitivity caseSensitivity,
    int jsonMaxDepth = 128)
  {
    _caseSensitivity = caseSensitivity;
    string json;
  ...
  ///   <see cref="JsonDocumentOptions.MaxDepth" />
  /// </param>
  public JsonLocalizationSource(FileInfo file, PropertyCaseSensitivity caseSensitivity,
    int jsonMaxDepth = 128)
  ...
  public IDictionary<string, string> GetAll(string culture)
  {
    ...
    foreach (var jsonProperty in cultureElement.EnumerateObject()) DFS(jsonProperty, all);
  ...
  private static bool TryGetPropertyByKeyCaseInsensitive(JsonElement element, string key,
